...
RDBMS is a system to manage relational databases.  SQL is a query language used to retrieve data from a relational database.

1. Why do tables need a `primary key`?

Tables require a primary key in order to keep entries uniquely identified.
